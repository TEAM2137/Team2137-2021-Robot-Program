...
//    private final HashMap<Path, Translation2d> limelightSampleSpace = new HashMap<>();

    public BallLimeLight() {
        super(NetworkTableInstance.getDefault().getTable("limelight-two"));
    ...
    public Path getClosestPath() {
        Translation2d value = new Translation2d(Math.toDegrees(getLimeLightValue(LimeLightValues.TX)), Math.toDegrees(getLimeLightValue(LimeLightValues.TY)));
