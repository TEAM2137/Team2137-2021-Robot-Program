...
public class Autonomous extends OpMode {
        ...
        public void init() {
                ...
                Motor lpm1 = new Motor("LPM1", 11, Motor.MotorTypes.NEO, false, 60, 97); // Counts per degree, ratio is
                                                                                         // 8.53
    ...
    public void loop() {
        if (System.currentTimeMillis() - startTime < 5000) {                
                ...
                base.setLeftVelocity(path.smoothLeftVelocity[pointNum][1]);
                base.setRightVelocity(path.smoothRightVelocity[pointNum][1]);
        }
    }
